    ...
    <div>
            ...
            <header class="container-fluid mb-4" style="padding-right: 7px"><!--container-fluid-->
                <div class="row align-items-center justify-content-between">
                    ...
                    <nav class="d-inline-block">
                        <nuxt-link class="link btn btn-lg btn-light" :class="{pureActive: $route.params.type == 'loose' || !$route.params.type}" :to="`/shop/diamonds/loose`">Loose</nuxt-link>
                        <nuxt-link class="link btn btn-lg btn-light" :class="{pureActive: $route.params.type == 'fancy'}" :to="`/shop/diamonds/fancy`">Fancy</nuxt-link>
                    </nav>
                </div>
            </header>
            <div class="mt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="container-fluid col-12">
                        <div class="d-flex justify-content-between">
                            <icon-checkbox label="Videos Only" prop="has_diamond_video" icon="subway:video-1" class="text-center" ></icon-checkbox>
                            <icon-checkbox label="Images Only" prop="has_real_image" icon="subway:image" class="text-center"></icon-checkbox>
        ...
        <div class="rangeFilters d-flex flex-column">
            ...
            <div class="filter-group">
                <list-filter v-if="$route.params.type === 'fancy'" @change="$emit('loadGalleryData',$event)" :list="$store.state.initialData.colorsArray" class="shopping-option-item" @togglefilter="toggleFilter()" prop="fancy_color" :params="source.queryParams.q">

                </list-filter>
                <list-filter @change="$emit('loadGalleryData',$event)" :list="$store.state.initialData.shapesArray" class="shopping-option-item" @togglefilter="toggleFilter()" prop="shape" :params="source.queryParams.q">
                    ...
                    var slider = {
                        ...
                        */
                        ...
                        onChange: function onChange(data) {
                            ...
                            if (val in source.query) source.query[val] = [data.from, data.to];
                        },
