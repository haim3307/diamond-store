                    ...
                    <div class="product-details">
                        <section>
                            <div class="row" style="    font-family: 'Montserrat'; ">
                                <h2 class="mb-3 col-md-9 productTitle" ><a :href="product.url" v-html="product.title" class="text-dark text-capitalize" style="    font-family: 'Montserrat';
"></a></h2>

                                <span class="price mb-3 d-block col-md-3 d-flex justify-content-center align-items-center" v-html="product.price" style="    font-family: 'Montserrat';
"></span>
                            </div>
                        </section>
                        ...
                        <div>
                            <social-sharing :url="$root.baseUrlSSL + product.url"
                        ...
                        <div class="product-quantity d-flex align-items-center" style="    margin-top: 17px;">
                            <!--<?php /*include VIEW_V3_DIR . '/includes/gallery/buttons/add-to-cart.html.php' */?>-->
                            <a class="btn btn-add-to-cart" @click.self="addToCart(product)" href="javascript:void(0)">+ Add to Cart</a>
                        </div>
                    </div>
                </div>
                <!-- Product Details End -->
...
<script>
    export default {
        ...
        methods:{
            ...
            {
                var url = '/api/products/show_json.json/?slug='+item.url.split('/')[2].split('-pid-')[0]+'&id='+item.id;
