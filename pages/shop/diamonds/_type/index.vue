                                ...
                                <div class="products-wrapper">
                                    ...
                                    <div v-else class="row">
                                        <div class="col-lg-4 col-sm-6"
                                             v-for="loadingItem in [1,2,3,4,6,7,8,9,10,11]">
...
/*            let breadcrumb =  this.$route.matched;
        ...
        async asyncData ({ $axios,query,route}) {
            ...
            let data = await $axios.$get(`/api/dyo/${route.params.type === 'fancy'?'color_':''}diamond`,    {params:query});
        ...
        methods:{
            ...
            addToCartDash (element) {debugger;
